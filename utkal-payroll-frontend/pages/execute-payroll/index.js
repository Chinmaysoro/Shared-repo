...
import ExecutePayrollModal from "./ExecutePayrollModal";
    ...
    return (
        <div className="page-wrapper card p-3">
            <div className="content container-fluid">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-6">
                                                <div className="button-group" role="group" style={{ marginTop: '23px' }}>
                                                    ...
                                                    <button className="btn btn-info" type="button" onClick={() => openModal('Execute Payroll', true, "")} title="Execute Payroll">
                                                        <i className="pi pi-sync"></i>&nbsp;Execute Payroll
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                ...
                <SimpleModal title={title} visible={visible} setVisible={() => setVisible(false)} body={<ExecutePayrollModal setVisible={() => setVisible(false)} />}></SimpleModal>
