...
import { CompanyService, DepartmentService, DesignationService, GradeService, ShiftPolicyService } from '../../redux/services/feathers/rest.app';
                ...
                <div className="col-md-3">
                    <div className="policy-app-attribute">
                        ...
                        <ul>
                            ...
                            <li>
                                <label>
                                    <input type="radio" name="a_type" value="employee" onChange={handleOptionChange} className="mr-1" /> Employee
                                </label>
                            </li>
                        </ul>
                    </div>
